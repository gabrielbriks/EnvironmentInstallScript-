...
cinst -y vlc git googlechrome firefox notepadplusplus.install lightshot server-jre10 python3 googlechrome vscode nodejs-lts winrar figma lunacy vscode yarn robo3t spotify insomnia-rest-api-client sublimetext3 
